...
func (m *UpstreamSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("static_localized.options.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/options/static_localized.UpstreamSpec")); err != nil {
		return 0, err
	}

	for _, v := range m.GetLocalizedHosts() {
...
// Hash function
func (m *LocalizedHosts) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("static_localized.options.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/options/static_localized.LocalizedHosts")); err != nil {
		return 0, err
	}
...
func (m *Host) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("static_localized.options.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/options/static_localized.Host")); err != nil {
		return 0, err
	}
...
func (m *Locality) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("static_localized.options.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/options/static_localized.Locality")); err != nil {
		return 0, err
	}
...
func (m *Host_HealthCheckConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("static_localized.options.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/options/static_localized.Host_HealthCheckConfig")); err != nil {
		return 0, err
	}
